...
def generate_heatmap(dicom_directory):
    ...
    # Flip Z and Y axes to match Frontend/VTK orientation
    # axis=0 (Z): Fixes Sagittal/Coronal upside-down issue
    # axis=1 (Y): Fixes Axial upside-down issue
    # axis=2 (X): Left as-is to fix lateral inversion
    heatmap_final_np = np.flip(heatmap_final_np, axis=(0, 1))
